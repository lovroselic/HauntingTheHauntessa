...
const SHRINE_TYPE = {
    ApparitiaDefense2: {
        ...
        price: 10000,
        level: 4,
        text: "Princess, shields chip, ammo argues better. Pay 10000 gold and I harden your guard and steady your trigger, best defense is to shoot first and keep walking.",
        introduce: true,
        voice: "Apparitia",
    },
    ApparitiaDefense1: {
        name: "ApparitiaDefense1",
        sprite: "ApparitiaDefense1",
        which: "defense",
        category: "crest",
        interactionCategory: "shrine",
        inventorySprite: "SkillShield",
        price: 7500,
        level: 3,
        text: "Trespasser, stop blocking with your face. Pay 7500 gold and I teach tight guards, neat sidesteps, and the classic defense, put bullets between you and trouble.",
        introduce: true,
        voice: "Apparitia",
    },
    ApparitiaMana2: {
        name: "ApparitiaMana2",
        sprite: "ApparitiaMana2",
        which: "mana",
        category: "crest",
        interactionCategory: "shrine",
        ...
        price: 10000,
        level: 4,
        text: "Princess, your spark is a drizzle. Pay 10000 gold and I flood you with mana, more casts, hotter fire, longer burn. No charity, no refunds.",
        introduce: true,
        voice: "Apparitia",
    },
    ApparitiaMana1: {
        name: "ApparitiaMana1",
        sprite: "ApparitiaMana1",
        which: "mana",
        category: "crest",
        interactionCategory: "shrine",
        inventorySprite: "ManaSkill",
        price: 7500,
        level: 3,
        text: "Pay 7500 gold, trespasser, and I thicken your mana flow, extra shots, brighter flames, fewer whimpers. Learn fast or get singed.",
        introduce: true,
        voice: "Apparitia",
    },
    ApparitiaHealth2: {
        name: "ApparitiaHealth2",
        sprite: "ApparitiaHealth2",
        which: "health",
        category: "crest",
        interactionCategory: "shrine",
        ...
        price: 10000,
        level: 4,
        text: "Princess, you bleed on our floors. Pay 10000 gold and I will make you harder to kill, hotter pulse, thicker hide. No whining, no refunds.",
        introduce: true,
        voice: "Apparitia",
    },
    ApparitiaHealth1: {
        name: "ApparitiaHealth1",
        sprite: "ApparitiaHealth1",
        which: "health",
        category: "crest",
        interactionCategory: "shrine",
        inventorySprite: "HeartSkill",
        price: 7500,
        level: 3,
        text: "You look fragile, trespasser. Pay 7500 gold and I will toughen your heart, more stamina, less swooning. Try not to enjoy it too much.",
        introduce: true,
        voice: "Apparitia",
    },
    ApparitiaAttack2: {
        name: "ApparitiaAttack2",
        sprite: "ApparitiaAttack2",
        which: "attack",
        category: 'crest',
        interactionCategory: 'shrine',
        ...
        price: 10000,
        level: 4,
        text: "Princess, hostile ground means pointy ends forward. Pay 10000 gold and I forge your attack, from dagger thrusts to stiletto strikes. No refunds, only bruises.",
        introduce: true,
        voice: "Apparitia",
    },
    ApparitiaAttack1: {
        name: "ApparitiaAttack1",
        sprite: "ApparitiaAttack1",
        which: "attack",
        category: 'crest',
        interactionCategory: 'shrine',
        inventorySprite: "SkillKick",
        price: 7500,
        level: 3,
        text: "Pay 7500 gold and I drill your quick jabs and nasty heel kicks, pointy ends where they hurt. Learn fast or limp away.",
        introduce: true,
        voice: "Apparitia",
    },
    ApparitiaMagic2: {
        name: "ApparitiaMagic2",
        sprite: "ApparitiaMagic2",
        which: "magic",
        category: 'crest',
        interactionCategory: 'shrine',
        ...
        price: 10000,
        level: 4,
        text: "Princess, this is Hauntessa ground. Pay 10000 gold, and I crank your magic to  hotter fireballs, meaner tricks. No charity, no refunds.",
        introduce: true,
        voice: "Apparitia",
    },
    ApparitiaMagic1: {
        name: "ApparitiaMagic1",
        sprite: "ApparitiaMagic1",
        which: "magic",
        category: 'crest',
        interactionCategory: 'shrine',
        inventorySprite: "SkillFireball",
        price: 7500,
        level: 3,
        text: "Kneel and pay 7500 gold, trespasser. I brand the basics into you, Fireball included. Walk away if you like smoke more than progress.",
        introduce: true,
        voice: "Apparitia",
    },
    TankaDaFensa: {
...
const ORACLE_TYPE = {
    ...
    BoneThroneSitter: {
        ...
        category: 'crest',
        voice: "FemaleLow6",
        text: "Not everyone in Hauntosphere is against you. Seek allies.",
        interactionCategory: "oracle",
    },
    SluttyRedBabe: {
        name: "SluttyRedBabe",
        sprite: "SluttyRedBabe",
        category: 'crest',
        voice: "FemaleLow3",
        text: "You know when I say, there will be no going back? This is the it. After you jump, only one way to go. Final battle.",
        interactionCategory: "oracle",
    },
    GhostFaceContinue: {
    ...
    HealingHeels2: {
        ...
        category: 'crest',
        voice: "FemaleLow3",
        text: "Don't spend you money at the temple all at once. Plan your visits. Or die. Who cares.",
        interactionCategory: "oracle",
    },
    HiddenEntrance: {
        name: "HiddenEntrance",
        ...
        category: 'crest',
        voice: "FemaleLow4",
        text: "If you can't find the hidden entrance, then you are hopeless. You will die here.",
        interactionCategory: "oracle",
    },
    DemolitionWhite: {
